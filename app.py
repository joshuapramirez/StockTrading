...
def buy():
    ...
    if request.method == "GET":
        ...
        flash(f"Bought {shares} shares of {stock['symbol']} for {usd(stock['price'])}/share!\n TOTAL COST: {usd(transaction_value)}")
...
def add_cash():
    ...
    if request.method == "GET":
        ...
        if not new_cash:
            return apology("You must submit an amount")
...
def sell():
    ...
    if request.method == "GET":
        ...
        if shares < 0:
            return apology("Must submit a positive number")
        ...
        flash(f"Sold {shares} shares of {stock['symbol']} for {usd(stock['price'])}/share!\n TOTAL VALUE: {usd(transaction_value)}")
